...
qplot(group,w12,data=WeightLoss,geom=boxplot,fill=group)
the.anova<-aov(w12~group,data=WeightLoss)
summary(the.anova)
pairwise.t.test(WeightLoss$w12,as.vector(WeightLoss$group))
